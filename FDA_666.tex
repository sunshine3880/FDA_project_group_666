...
The fourth column represents  US National Housing Price Index Value and the last one is 30-Year Conventional MortgageRate(DISCONTINUED), which we use v4 and v5 to stand for the two columns in our code.
We did some basic analysis to the data as followed:
...
This time we are using the ARIMA(5,0,4):
\begin{equation}
\begin{aligned}
